...
motor liftMotorMotorA = motor(PORT19, ratio18_1, true);
motor liftMotorMotorB = motor(PORT20, ratio18_1, false);
...
drivetrain Drivetrain = drivetrain(LeftDriveSmart, RightDriveSmart, 319.19, 431.79999999999995, 7.112, mm, 1);
